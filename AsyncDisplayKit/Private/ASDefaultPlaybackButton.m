...
{
  NSDictionary *dicparamters = (NSDictionary *)parameters;
  ASDefaultPlaybackButtonType buttonType = [dicparamters[@"buttonType"] intValue];
  UIColor *color = dicparamters[@"color"];
