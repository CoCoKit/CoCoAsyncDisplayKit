...
#import "ASDisplayNode+Frame.h"

@implementation ASDisplayNode (Frame)
- (CGFloat)top
{
...
- (void)setCenterX:(CGFloat)centerX {
    self.frame = CGRectMake(centerX-self.frame.size.width/2.0, self.origin.y, self.frame.size.width, self.frame.size.height);
...
- (void)setCenterY:(CGFloat)centerY {
        self.frame = CGRectMake(self.origin.x,centerY-self.frame.size.height/2.0,  self.frame.size.width, self.frame.size.height);
}
